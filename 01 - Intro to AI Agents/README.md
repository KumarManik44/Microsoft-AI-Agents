...
- Understanding AI Agent concepts and how they differ from other AI solutions.
- Applying AI Agents most efficiently.
- Designing Agentic solutions productively for both users and customers.
...
The first step in designing an AI Agent system is to define the tools, actions, and behaviors. In this project, we focus on using the **Azure AI Agent Service** to define our Agents. It offers features like:
...
This project is divided into some of the current popular Agentic patterns.
...
In this project, we will explore the research-driven AutoGen framework and the production-ready Agent framework from Semantic Kernel.
