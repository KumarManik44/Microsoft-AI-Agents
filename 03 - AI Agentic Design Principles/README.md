...
1. Explaining what the Agentic Design Principles are
2. Explaining the guidelines for using the Agentic Design Principles
3. Understanding how to build an agent using the Agentic Design Principles
